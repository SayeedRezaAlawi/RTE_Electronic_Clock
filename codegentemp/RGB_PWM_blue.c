...
void RGB_PWM_blue_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(RGB_PWM_blue_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 RGB_PWM_blue_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(RGB_PWM_blue_CAPTURE_LSB_PTR));
    }
...
void RGB_PWM_blue_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(RGB_PWM_blue_PERIOD_LSB_PTR, period);
    #endif /* (RGB_PWM_blue_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(RGB_PWM_blue_COMPARE1_LSB_PTR, compare);
        #endif /* (RGB_PWM_blue_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(RGB_PWM_blue_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (RGB_PWM_blue_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(RGB_PWM_blue_COMPARE2_LSB_PTR, compare);
        #endif /* (RGB_PWM_blue_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(RGB_PWM_blue_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(RGB_PWM_blue_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(RGB_PWM_blue_COMPARE1_LSB_PTR));
        #endif /* (RGB_PWM_blue_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(RGB_PWM_blue_COMPARE2_LSB_PTR));
    }
...
{
    #if(RGB_PWM_blue_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(RGB_PWM_blue_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(RGB_PWM_blue_PERIOD_LSB_PTR));
    #endif /* (RGB_PWM_blue_UsingFixedFunction) */
}
