 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (tsk_CyclicDispatcher) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 1200/4 // size = 1200 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_EventDispatcher) */
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,Tsk3	 /* tsk_CyclicDispatcher*/
    #endif
    #if EE_MAX_TASK > 3
        ,Tsk4	 /* tsk_EventDispatcher*/
    #endif
    #if EE_MAX_TASK > 4
        ,Tsk5	 /* Task_5*/
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_CyclicDispatcher*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_EventDispatcher*/
        #endif
        #ifdef TASK_5_STACK_SIZE
