...
*  file    LCD_signal.h
*
*  brief   signal base class for signal lcd
*
...
#ifndef LCD_SIGNAL_H_INCLUDED
#define LCD_SIGNAL_H_INCLUDED

/*================================================[ configuration  ]================================================*/
#define LCD_DATATRIGGER OFF
 ...
 *  I-Port
 */
typedef RC_t (*LCD_driverIn_t)(LCD_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*LCD_driverOut_t)( const LCD_data_t * const);
...
/**
 * Instances of the struct LCD_cfg_t represent the signal object configuration.
 */
struct LCD_cfg_s
{
    /**
     ...
     */
    LCD_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   LCD_driverOut_t const outDriver;
...
typedef const struct LCD_cfg_s LCD_cfg_t;
...
/**
 * Instances of the struct LCD_t represent the signal objects.
 ...
 *
 * @param  LCD_t * const signal: Pointer to the signal object which will be initialised
 * @param const lcd_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_LCD_init( LCD_t * const signal, const LCD_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  LCD_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_LCD_getStatus( const LCD_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_LCD_setStatus( LCD_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_LCD_getAge( const LCD_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_LCD_incAge(  LCD_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  LCD_t * const signal: Pointer to the signal object
 * @return lcd_data_t: current value of the application data buffer
 *
 **/
inline LCD_data_t RTE_LCD_get( const LCD_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  LCD_t * const signal: Pointer to the signal object
 * @param  lcd_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_LCD_set(LCD_t * const signal, const LCD_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_LCD_pullPort( LCD_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
 ...
 *
 **/
inline RC_t RTE_LCD_pushPort( const LCD_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
